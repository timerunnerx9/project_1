...
public class tempReimb {
	private String reimb_id;//serial type, generated from database
	...
	public tempReimb(String reimb_id, String reimb_amount, String reimb_submitted, String reimb_resolved,
			String reimb_description, String reimb_receipt, String reimb_author, String reimb_resolver,
			String reimb_status_id, String reimb_type_id) {
		super();
